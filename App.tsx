...
const AppContent: React.FC = () => {
  ...
  const handleClosePeriod = async () => {
    ...
    await closeAndStartNextPeriod(nextMonthStart, templates);
    toast.success('今月を確定しました');
  };
    ...
    <div className="min-h-screen flex flex-col">
      ...
      {modal && (
        <Modal
          ...
          onSave={(modal.type === 'ACCOUNT' || modal.type === 'ACCOUNT_EDIT') ? handleSaveAccount : (modal.type === 'TEMPLATE' || modal.type === 'TEMPLATE_EDIT') ? handleSaveTemplate : modal.type === 'ITEM_ADD' ? handleSaveItem : modal.type === 'COST_UPDATE' ? handleUpdatePaymentDate : undefined}
          onPayCost={handlePayCost}
